...
global.pair = 'https://khanmd-xpair.onrender.com';
global.pairx = 'https://khanmd-pair.onrender.com';
...
export default {
  ...
  MENU_IMAGE_URL: settings.MENU_IMAGE_URL || process.env.MENU_IMAGE_URL || "https://files.catbox.moe/6zd0ru.jpg",
  BOT_MEDIA_URL: settings.BOT_MEDIA_URL || process.env.BOT_MEDIA_URL || "https://files.catbox.moe/6zd0ru.jpg",
  AUDIO_URL: settings.AUDIO_URL || process.env.AUDIO_URL || 'https://files.catbox.moe/0toicz.mp3',
